 ...
 * [[cz.payola.data.squeryl.entities.plugins.TransformerPluginInstanceLike]] entities
 */
trait TransformerPluginInstanceRepositoryComponent extends TableRepositoryComponent
{
    self: SquerylDataContextComponent =>

    /**
     * A repository to access persisted [[cz.payola.data.squeryl.entities.plugins.TransformerPluginInstanceLike]] entities
     */
    trait TransformerPluginInstanceTableRepository[A <: Entity with TransformerPluginInstanceLike]
    {
        ...
        def persistPluginInstance(pluginInstance: cz.payola.domain.entities.plugins.TransformerPluginInstance) {
        ...
        private def _getLoadQuery(entityFilter: (TransformerPluginInstanceLike) => LogicalBoolean) = {
        ...
        protected def loadPluginInstancesByFilter(entityFilter: (TransformerPluginInstanceLike) => LogicalBoolean):
        Seq[TransformerPluginInstanceLike] = schema.wrapInTransaction {
        ...
        private def _mapParameterValuesToParameters(pluginInstanceLike: TransformerPluginInstanceLike) {
