 ...
 */
class TransformerPluginInstance(protected var _plugin: Plugin, var _parameterValues: immutable.Seq[ParameterValue[_]])
    extends Entity
    with cz.payola.common.entities.plugins.TransformerPluginInstance
{
     ...
     */
    def setParameter(parameterName: String, value: Any): TransformerPluginInstance = {
     ...
     */
    def setParameter(parameter: Parameter[_], value: Any): TransformerPluginInstance = {
     ...
     */
    def setParameter(parameterValue: ParameterValue[_], newValue: Any): TransformerPluginInstance = {
    ...
    override def canEqual(other: Any): Boolean = {
        other.isInstanceOf[TransformerPluginInstance]
    }
