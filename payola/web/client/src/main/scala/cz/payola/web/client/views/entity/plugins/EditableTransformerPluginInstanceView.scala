...
class EditableTransformerPluginInstanceView(pluginInst: TransformerPluginInstance, predecessors: Seq[TransformerPluginInstanceView] = List(),
    prefixApplier: PrefixApplier) extends TransformerPluginInstanceView(pluginInst, predecessors, prefixApplier)
{
